...
def create_timelapse(filepath):
    try:
        ...
        subprocess.call("mencoder mf://*.jpg -nosound -of lavf -lavfopts format=mp4 -ovc x264 -x264encopts pass=1:bitrate=2000:crf=24 -o %s -mf type=jpg:fps=15" % filepath ,shell=True)
    except:
